<template>
  <div class="product-view">
      ...
      <div v-for="(product, index) in filteredProductList" :key="index" class="product-item">
        ...
        <div class="product-info">
          <template v-if="editingProduct === product">
            ...
            <input type="text" v-model="product.price1" class="edit-input" />
            <textarea v-model="product.description" class="edit-textarea"></textarea>
            <div>
    ...
    <div v-if="isAddingProduct" class="add-product-form">
      <h3>添加商品</h3>
      <input type="file" @change="handleFileChange" accept="image/*" class="add-input" />
      <template v-if="newProductImage">
        <img :src="newProductImage" alt="Preview" class="preview-image" />
      </template>
      <input type="text" v-model="newProduct.name" placeholder="商品名称" class="add-input" />
      <input type="text" v-model="newProduct.price" placeholder="商品价格" class="add-input" />
      <textarea v-model="newProduct.description" placeholder="商品描述" class="add-textarea"></textarea>
      <div>
