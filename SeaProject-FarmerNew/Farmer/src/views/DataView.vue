...
const historyData = {
  ...
  '2024-02-14': { values: [15, 6.5, 8.1, 2.8, 7.1, 0.45, 0.13, 0.09, 0.35, 3.7], wqis: 85 },
  '2024-02-15': { values: [13, 8, 7.7, 2.9, 6.2, 0.48, 0.16, 0.13, 0.42, 3.9], wqis: 87 },
  '2024-02-16': { values: [14, 7, 7.8, 3, 6.7, 0.5, 0.14, 0.11, 0.38, 4], wqis: 90 },// 今天
};
